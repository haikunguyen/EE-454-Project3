%This function renders a video for persistent frame differencing
%function persistFrameDifference(folder)
    folder = '/ArenaA/';
    ...
    image0 = strcat('DataSets',folder,files(1).name); %concat file path to first picture (t=0)
